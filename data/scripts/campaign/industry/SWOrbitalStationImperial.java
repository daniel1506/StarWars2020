...
public class SWOrbitalStationImperial extends OrbitalStation
{
    public boolean isAvailableToBuild() {
        ...
        if (!this.market.hasIndustry("sw_golan_iii_imperial") && this.market.getPlanetEntity() != null && !player.getRelationshipLevel(empire).isAtWorst(RepLevel.WELCOMING) && !Global.getSector().getPlayerFaction().knowsIndustry(this.getId())) {
            canBuild = false;
        }
        return canBuild;
    }
