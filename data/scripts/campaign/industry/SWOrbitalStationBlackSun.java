...
public class SWOrbitalStationBlackSun extends OrbitalStation
{
    public boolean isAvailableToBuild() {
        ...
        if (!this.market.hasIndustry("sw_golan_iii_blacksun") && this.market.getPlanetEntity() != null && !player.getRelationshipLevel(blacksun).isAtWorst(RepLevel.WELCOMING) && !Global.getSector().getPlayerFaction().knowsIndustry(this.getId())) {
            canBuild = false;
        }
        return canBuild;
    }
