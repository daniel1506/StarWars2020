...
public class SWOrbitalStationZann extends OrbitalStation
{
    public boolean isAvailableToBuild() {
        ...
        if (!this.market.hasIndustry("sw_golan_iii_zann") && this.market.getPlanetEntity() != null && !player.getRelationshipLevel(zann).isAtWorst(RepLevel.WELCOMING) && !Global.getSector().getPlayerFaction().knowsIndustry(this.getId())) {
            canBuild = false;
        }
        return canBuild;
    }
