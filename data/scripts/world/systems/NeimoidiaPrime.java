...
public class NeimoidiaPrime {

	public void generate(SectorAPI sector) {
		
		StarSystemAPI system = sector.createStarSystem("Neimoidia");
		LocationAPI hyper = Global.getSector().getHyperspace();
		
		system.setBackgroundTextureFilename("graphics/backgrounds/background5.jpg");
		system.getLocation().set(6149.7f, 10249.5f);
		//system.getLocation().set(6149.7f, 7090.5f);
		//Star Wars map to Starsector map ratio: 1x1 (grid) : 6833x4727
		
		SectorEntityToken neimoidia_nebula = Misc.addNebulaFromPNG("data/campaign/terrain/valhalla_nebula.png",
		...
		PlanetAPI neimoidia_star = system.initStar("neimoidia_prime", // unique id for this star 
		...
		PlanetAPI neimoidia1 = system.addPlanet("neimoidia", neimoidia_star, "Neimoidia", "terran", 24, 108.3f, 5000, 221);
		neimoidia1.getSpec().setPlanetColor(new Color(205,205,205,205));
		neimoidia1.setCustomDescriptionId("planet_neimoidia");
		neimoidia1.applySpecChanges();
		...
		MarketAPI neimoidia_market = SW_AddMarket.SW_AddMarket("sw_cis", (SectorEntityToken)neimoidia1, null, "Neimoidia", 9, new ArrayList<String>(Arrays.asList("population_9", "habitable", "mild_climate", "terran", "farmland_rich", "organics_abundant", "volatiles_plentiful")), new ArrayList<String>(Arrays.asList("population", "megaport", "militarybase", "farming", "mining", "fuelprod", "patrolhq", "heavybatteries", "sw_golan_iii_cis")), new ArrayList<String>(Arrays.asList("storage", "black_market", "open_market", "generic_military")), 0.2f);
		
		MarketAPI neimoidia_shipyards_market = SW_AddMarket.SW_AddMarket("sw_cis", (SectorEntityToken)neimoidiaStation, null, "Neimoidia Shipyard", 8, new ArrayList<String>(Arrays.asList("population_8", "no_atmosphere", "outpost", "industrial_polity")), new ArrayList<String>(Arrays.asList("population", "spaceport", "militarybase", "lightindustry", "orbitalworks", "waystation", "heavybatteries", "sw_shipyards_cis")), new ArrayList<String>(Arrays.asList("storage", "black_market", "open_market", "generic_military")), 0.3f);				
		
		SpecialItemData nanoforge = new SpecialItemData("pristine_nanoforge", "special_item1");
		neimoidia_shipyards_market.getIndustry("orbitalworks").setSpecialItem(nanoforge);
		neimoidia_shipyards_market.getIndustry("militarybase").setAICoreId("alpha_core");
		neimoidia_shipyards_market.getIndustry("lightindustry").setAICoreId("alpha_core");		
		neimoidia_shipyards_market.getIndustry("waystation").setAICoreId("alpha_core");
		neimoidia_shipyards_market.getIndustry("sw_shipyards_cis").setAICoreId("alpha_core");
		neimoidia_shipyards_market.getIndustry("population").setAICoreId("beta_core");
		neimoidia_shipyards_market.getIndustry("spaceport").setAICoreId("beta_core");
		neimoidia_shipyards_market.getIndustry("heavybatteries").setAICoreId("beta_core");
		
		neimoidia_market.getIndustry("militarybase").setAICoreId("alpha_core");
		neimoidia_market.getIndustry("farming").setAICoreId("alpha_core");		
		neimoidia_market.getIndustry("mining").setAICoreId("alpha_core");
		neimoidia_market.getIndustry("fuelprod").setAICoreId("alpha_core");
		neimoidia_market.getIndustry("patrolhq").setAICoreId("alpha_core");
		neimoidia_market.getIndustry("sw_golan_iii_cis").setAICoreId("alpha_core");
		neimoidia_market.getIndustry("population").setAICoreId("beta_core");
		neimoidia_market.getIndustry("megaport").setAICoreId("beta_core");
		neimoidia_market.getIndustry("heavybatteries").setAICoreId("beta_core");
		...
		// jump point 
		JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("neimoidia_inner_jump", "Neimoidia Inner System Jump-point");
		OrbitAPI orbit = Global.getFactory().createCircularOrbit(neimoidia1, 0, 1500, 65);
		jumpPoint.setOrbit(orbit);
		jumpPoint.setRelatedPlanet(neimoidia1);
