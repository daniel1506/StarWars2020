...
public class KaminoPrime {
	...
	public void generate(SectorAPI sector) {
		...
		system.getLocation().set(41681.3f, -22548.9f);
		...
		PlanetAPI kamino1 = system.addPlanet("kamino", kamino_star, "Kamino", "water", 24, 192.7f, 5000, 463);
		...
		MarketAPI kamino_market = SW_AddMarket.SW_AddMarket("sw_republic", (SectorEntityToken)kamino1, null, "Kamino", 9, new ArrayList<String>(Arrays.asList("population_9", "habitable", "water", "regional_capital", "headquarters", "organics_abundant", "volatiles_plentiful")), new ArrayList<String>(Arrays.asList("population", "spaceport", "highcommand", "mining", "fuelprod", "aquaculture", "patrolhq", "cryosanctum", "heavybatteries", "sw_golan_iii_republic", "planetaryshield")), new ArrayList<String>(Arrays.asList("storage", "black_market", "open_market", "generic_military")), 0.3f);
		...
		kamino_market.getIndustry("highcommand").setAICoreId("alpha_core");
		kamino_market.getIndustry("mining").setAICoreId("alpha_core");		
		kamino_market.getIndustry("fuelprod").setAICoreId("alpha_core");
		kamino_market.getIndustry("patrolhq").setAICoreId("alpha_core");
		kamino_market.getIndustry("sw_golan_iii_republic").setAICoreId("alpha_core");
		kamino_market.getIndustry("population").setAICoreId("beta_core");
		kamino_market.getIndustry("spaceport").setAICoreId("beta_core");
		kamino_market.getIndustry("heavybatteries").setAICoreId("beta_core");
		kamino_market.getIndustry("planetaryshield").setAICoreId("beta_core");
		...
		// jump point 
		JumpPointAPI jumpPoint = Global.getFactory().createJumpPoint("kamino_inner_jump", "Kamino Inner System Jump-point");
