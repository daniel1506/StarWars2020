...
public class TractorBeamAI implements ShipSystemAIScript {
	...
	public void advance(float amount, Vector2f missileDangerDir, Vector2f collisionDangerDir, ShipAPI target) {		
		...
		if (tracker.intervalElapsed()) {
			...
			if (shipTarget != null && shipTarget.getHullSize() != HullSize.CAPITAL_SHIP && shipTarget.getHullSize() != HullSize.FIGHTER) {
				if (shipTarget.getMutableStats().getMaxSpeed().getModifiedValue() != 0f) {
					...
					if (dist <= (1500f + ship.getCollisionRadius())) {
